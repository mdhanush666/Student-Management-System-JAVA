...
// Db Connect...    
    ...
    public SettingYourActivity() {
        ...
        try {
            qry = "SELECT (login_history) FROM student_login_history WHERE userName = '" + LoginUser.getUser + "'";
    ...
    private void initComponents() {
        ...
        txtPane1.setBackground(new java.awt.Color(0, 0, 102));
        ...
        btnClearLoginHistory.setBackground(new java.awt.Color(0, 0, 204));
    ...
    private void btnClearLoginHistoryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnClearLoginHistoryActionPerformed
        ...
        try {
            qry = "DELETE FROM student_login_history WHERE UserName = '" + LoginUser.getUser + "'";
