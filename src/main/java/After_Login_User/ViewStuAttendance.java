...
// table style and behaviour...        
    ...
    private void initComponents() {
        ...
        bgPannel.setBackground(new java.awt.Color(0, 0, 102));
        ...
        tblStuAttendance.setBackground(new java.awt.Color(0, 0, 102));
        ...
        cmbYear.setBackground(new java.awt.Color(0, 0, 102));
        ...
        cmbMonth.setBackground(new java.awt.Color(0, 0, 102));
        ...
        cmbMIS.setBackground(new java.awt.Color(0, 0, 102));
