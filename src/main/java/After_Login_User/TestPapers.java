...
// Constructor...    
    public TestPapers() {
        ...
        try {
            qry = "SELECT File_Name,File_Location,time FROM students_testpapers ORDER BY (time)DESC";
...
// set theme..        
    ...
    private void btnOpenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOpenActionPerformed
        ...
        if(rowIndex == -1){
            JOptionPane.showMessageDialog(null, "Please select the Test Paper to Open");
        }
        else{
