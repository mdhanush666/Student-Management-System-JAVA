...
public class SettingThemes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cmbBgC.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Default", "Blue", "Black" }));
    ...
    private void btnSetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSetActionPerformed
        ...
        if(cmbBgC.getSelectedIndex() == 0){ // Default
            ...
            try{
                qry = "UPDATE admin_profile SET Theme = ? WHERE PID = 1";
        ...
        else if(cmbBgC.getSelectedIndex() == 1){    // Blue
