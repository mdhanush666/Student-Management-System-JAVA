...
public class ProfileImgsAdmin extends javax.swing.JFrame implements ActionListener{
...
// Db Connect..    
    ...
    public void actionPerformed(ActionEvent e){
        if(e.getSource() == btn1){
            ...
            qry = "UPDATE admin_profile SET IMG = ? WHERE PID = 1";
            getImgNo = 1;
        }
