...
public class Notes extends javax.swing.JFrame{
    ...
    public int OpenFileChooser(String OpenPath){
        ...
        fileChooser.setDialogTitle("Select Notes");
...
// set theme..        
        if(Home.getTheme.equalsIgnoreCase("default")){
            ...
            btnSharedNotes.setBackground(new Color(160,160,0));
        }
        else{
            ...
            btnSharedNotes.setBackground(Home.SideBar);
        }
    ...
    private void initComponents() {
        ...
        btnSharedNotes = new javax.swing.JButton();
        ...
        btnUpload.setText("Upload Notes");
        ...
        bgPanel.add(btnUpload, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 210, 210, 50));
        ...
        lblHeading.setText("Share Notes");
        ...
        btnSharedNotes.setBackground(new java.awt.Color(160, 160, 0));
        btnSharedNotes.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        btnSharedNotes.setForeground(new java.awt.Color(255, 255, 255));
        btnSharedNotes.setText("Shared Notes");
        btnSharedNotes.setFocusable(false);
        btnSharedNotes.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnSharedNotesActionPerformed(evt);
            }
        });
        bgPanel.add(btnSharedNotes, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 320, 130, 40));
    ...
    private void btnUploadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUploadActionPerformed
        ...
        FileNameExtensionFilter filter = new FileNameExtensionFilter("Notes (pdf, jpg, jpeg, png, pptx)","pdf","jpeg","jpg","png","pptx");
    ...
    private void btnShareNotesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnShareNotesActionPerformed
        ...
        try {
            qry = "INSERT INTO students_notes (File_Name,File_Location) VALUES(?,?)";
            ...
            JOptionPane.showMessageDialog(null, "Notes Shared Success","Share Notes",JOptionPane.INFORMATION_MESSAGE);
            dispose();
            new Home();
        } 
        catch (Exception e) {
    ...
    private void btnSharedNotesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSharedNotesActionPerformed
        // TODO add your handling code here:
        new SharedNotes();
    }//GEN-LAST:event_btnSharedNotesActionPerformed
    ...
    private javax.swing.JButton btnSharedNotes;
