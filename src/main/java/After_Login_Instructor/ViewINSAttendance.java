...
public class ViewINSAttendance extends javax.swing.JFrame {
...
// table style and behaviour...        
    ...
    private void initComponents() {
        ...
        bgPannel.setBackground(new java.awt.Color(204, 204, 0));
        ...
        tblStuAttendance.setBackground(new java.awt.Color(153, 153, 0));
        ...
        cmbYear.setBackground(new java.awt.Color(204, 204, 0));
        ...
        jLabel3.setText("INSTRUCTOR ATTENDANCE");
        ...
        cmbMonth.setBackground(new java.awt.Color(204, 204, 0));
        ...
        cmbMIS.setBackground(new java.awt.Color(204, 204, 0));
        cmbMIS.setFont(new java.awt.Font("Calibri", 2, 16)); // NOI18N
        cmbMIS.setForeground(new java.awt.Color(255, 255, 255));
        cmbMIS.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Student ID" }));
    ...
    private void cmbMonthActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbMonthActionPerformed
        ...
        cmbMIS.addItem("Select Instructor ID");
...
// getting the class days....                
            ...
            if(cmbYear.getSelectedIndex() == 0 && cmbMonth.getSelectedIndex() == 0){
                try {
                    ...
                    int getINSCount = model.getRowCount();                    
                    double tD = getClassDays * getINSCount;
                    avg = ((double)p / tD) * 100;
...
// getting Selected ID...and setting values..
