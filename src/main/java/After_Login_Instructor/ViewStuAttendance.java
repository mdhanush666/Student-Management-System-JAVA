...
// set theme...        
        bgPannel.setBackground(Home.SideBar);
        tblStuAttendance.getTableHeader().setBackground(Home.SideBar); 
        tblStuAttendance.setBackground(Home.body);
        cmbMonth.setBackground(Home.SideBar);
        cmbYear.setBackground(Home.SideBar);
        cmbMIS.setBackground(Home.SideBar);
...
// table style and behaviour...        
    ...
    private void initComponents() {
        ...
        bgPannel.setBackground(new java.awt.Color(153, 153, 0));
        ...
        tblStuAttendance.setBackground(new java.awt.Color(204, 204, 0));
        ...
        cmbYear.setBackground(new java.awt.Color(153, 153, 0));
        ...
        cmbMonth.setBackground(new java.awt.Color(153, 153, 0));
        ...
        cmbMIS.setBackground(new java.awt.Color(153, 153, 0));
