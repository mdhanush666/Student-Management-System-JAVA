...
public class SharedPapers extends javax.swing.JFrame {
...
// DB Connect..
    ...
    public SharedPapers() {
        ...
        try {
            qry = "SELECT File_Name,time FROM students_testpapers ORDER BY (time)DESC";
...
// set theme..        
    ...
    private void initComponents() {
        ...
        lblHeading.setText("Shared Test Papers");
