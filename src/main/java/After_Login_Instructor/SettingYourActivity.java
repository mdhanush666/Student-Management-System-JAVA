...
// Db Connect...    
    ...
    public SettingYourActivity() {
        ...
        try {
            qry = "SELECT (login_history) FROM instructor_login_history WHERE userName = '" + Login_Instructor.getUser + "'";
    ...
    private void initComponents() {
        ...
        txtPane1.setBackground(new java.awt.Color(204, 204, 0));
        ...
        btnClearLoginHistory.setBackground(new java.awt.Color(153, 153, 0));
    ...
    private void btnClearLoginHistoryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnClearLoginHistoryActionPerformed
        ...
        try {
            qry = "DELETE FROM instructor_login_history WHERE UserName = '" + Login_Instructor.getUser + "'";
