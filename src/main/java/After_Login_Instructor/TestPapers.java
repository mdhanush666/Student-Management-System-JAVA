 ...
 * @author Dhanush
 */
public class TestPapers extends javax.swing.JFrame{
    ...
    public int OpenFileChooser(String OpenPath){
        ...
        fileChooser.setDialogTitle("Select Papers");
...
// set theme..        
        if(Home.getTheme.equalsIgnoreCase("default")){
            ...
            btnSharedPapers.setBackground(new Color(160,160,0));
        }
        else{
            ...
            btnSharedPapers.setBackground(Home.SideBar);
        }
    ...
    private void initComponents() {
        ...
        btnSharedPapers = new javax.swing.JButton();
        ...
        btnUpload.setText("Upload Test Papers");
        ...
        bgPanel.add(btnUpload, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 210, 240, 50));
        ...
        lblHeading.setText("Share Test Papers");
        bgPanel.add(lblHeading, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 49, 588, 66));
        ...
        btnSharedPapers.setBackground(new java.awt.Color(160, 160, 0));
        btnSharedPapers.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        btnSharedPapers.setForeground(new java.awt.Color(255, 255, 255));
        btnSharedPapers.setText("Shared Papers");
        btnSharedPapers.setFocusable(false);
        btnSharedPapers.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnSharedPapersActionPerformed(evt);
            }
        });
        bgPanel.add(btnSharedPapers, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 320, 150, 40));
    ...
    private void btnUploadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUploadActionPerformed
        ...
        FileNameExtensionFilter filter = new FileNameExtensionFilter("Test Papers (pdf, jpg, jpeg, png, pptx)","pdf","jpeg","jpg","png","pptx");
    ...
    private void btnShareNotesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnShareNotesActionPerformed
        ...
        try {
            qry = "INSERT INTO students_testpapers (File_Name,File_Location) VALUES(?,?)";
            ...
            JOptionPane.showMessageDialog(null, "Test Papers Shared Success","Share Test Papers",JOptionPane.INFORMATION_MESSAGE);
            dispose();
            new Home();
        } 
        catch (Exception e) {
    ...
    private void btnSharedPapersActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSharedPapersActionPerformed
        // TODO add your handling code here:
        new SharedPapers();
    }//GEN-LAST:event_btnSharedPapersActionPerformed
    ...
    private javax.swing.JButton btnSharedPapers;
