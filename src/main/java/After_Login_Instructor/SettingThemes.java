...
public class SettingThemes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cmbBgC.setBackground(new java.awt.Color(204, 204, 0));
        ...
        btnSet.setBackground(new java.awt.Color(153, 153, 0));
    ...
    private void btnSetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSetActionPerformed
        ...
        if(cmbBgC.getSelectedIndex() == 0){ // Default
            ...
            try{
                qry = "UPDATE instructor_login_details SET Theme = ? WHERE userName = '" + Login_Instructor.getUser + "'";
