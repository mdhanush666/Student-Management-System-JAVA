...
// getting old Password & Username        
        ...
        try{
            ...
            qry = "SELECT userName,password FROM instructor_login_details WHERE ID = '"+ Home.getID +"'";
...
//        txtUsername.setEditable(false);
    ...
    private void initComponents() {
        ...
        panelSide.setBackground(new java.awt.Color(153, 153, 0));
        panelSide.setPreferredSize(new java.awt.Dimension(350, 400));
        ...
        getContentPane().add(panelSide, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, 500));
