...
// set the behaviour to update btn...        
        try {
            ...
            qry = "SELECT `" + todayDate.getDayOfMonth() +"` FROM " + concatMonth_Year + " WHERE ID = '" + Home.getID + "'" ;
    ...
    private void initComponents() {
        ...
        bgPanel.setBackground(new java.awt.Color(204, 204, 0));
        ...
        rdbPresent.setBackground(new java.awt.Color(204, 204, 0));
        ...
        if(count % 2 == 0){
            ...
            try {
                qry = "UPDATE " + concatMonth_Year + " SET `" 
                    + todayDate.getDayOfMonth() +"` = '1' WHERE ID = '" + Home.getID + "'" ;
